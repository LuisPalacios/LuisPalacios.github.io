...
<img src="/img/posts/logo-bitvaultwarden.svg" alt="Logo Bit y Vault warden" width="150px" style="float:left; padding-right:25px"  />
...
- En contenedor LXC con un [Proxmox VE Helper-Scripts](https://community-scripts.github.io/ProxmoxVE/scripts) > *Authentication & Security* > *Vaultwarden*.
- En Raspberry Pi 5 que tengo dedicada a NextCloud, siempre está encendida.

En ambos casos es obligatorio tener en tu casa un [Nginx Proxy Manager](https://nginxproxymanager.com). Yo ya lo tenía, y lo documenté en mi apunte sobre [Domótica y Networking]({{< relref "2023-04-08-networking-avanzado.md" >}}), busca la sección *Proxy Inverso*.
...
<div class="image-box">
  <img src="/img/posts/2025-03-02-bitwarden-01.svg" alt="Configuración final" width="300px" />
  <div class="image-caption">Configuración final</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2025-03-02-bitwarden-02.png" alt="Conexión inicial con el servidor" width="400px" />
  <div class="image-caption">Conexión inicial con el servidor</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2025-03-02-bitwarden-03.png" alt="Creación de mi usuario" width="400px" />
  <div class="image-caption">Creación de mi usuario</div>
</div>

Vuelvo a hacer login y ya tengo acceso a mi servidor Vaultwarden (Bitwarden).

<div class="image-box">
  <img src="/img/posts/2025-03-02-bitwarden-04.png" alt="Acceso al servidor local" width="400px" />
  <div class="image-caption">Acceso al servidor local</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2025-03-02-bitwarden-05.png" alt="Exportación" width="400px" />
  <div class="image-caption">Exportación</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2025-03-02-bitwarden-06.png" alt="Importación" width="400px" />
  <div class="image-caption">Importación</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2025-03-02-bitwarden-07.png" alt="Pi5 ejecutando NextCloud y Vaultwarden" width="400px" />
  <div class="image-caption">Pi5 ejecutando NextCloud y Vaultwarden</div>
</div>
