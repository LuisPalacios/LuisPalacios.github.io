...
<img src="/img/posts/logo-eclipse-gitea.svg" alt="Logo quidomi" width="150px" style="float:left; padding-right:25px"  />
...
| Encontrarás un par de apuntes sobre GIT en este blog, si quieres profundizar y entender git de verdad, te recomiendo [GIT en detalle]({{< relref "2021-04-17-git-en-detalle.md" >}}) y la [Chuleta sobre GIT]({{< relref "2021-10-10-git-cheatsheet.md" >}}). Si te interesa como montar Gitea en tu red casera, [aquí]({{< relref "2022-03-26-gitea-vm.md" >}}) y [aquí]({{< relref "2022-04-03-gitea-docker.md" >}}) también te dejo un par de apuntes. |
...
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-27.png" alt="Doy de alta mi clave en gitea" width="600px" />
  <div class="image-caption">Doy de alta mi clave en gitea</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-28.png" alt="Indico el carpeta raíz para mis proyectos en Gitea" width="800px" />
  <div class="image-caption">Indico el carpeta raíz para mis proyectos en Gitea</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-11.png" alt="Crear un nuevo repositorio" width="300px" />
  <div class="image-caption">Crear un nuevo repositorio</div>
</div>

Defino los parámetros necesarios

<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-22.png" alt="Parámetros para la creación del repositorio" width="500px" />
  <div class="image-caption">Parámetros para la creación del repositorio</div>
</div>

Una vez creado ya tengo acceso a la URL que usaremos más adelante para hacer el clonado.

<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-25.png" alt="Contenido del nuevo repositorio" width="600px" />
  <div class="image-caption">Contenido del nuevo repositorio</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-29.png" alt="Muestro la ventana de trabajo con repositorios" width="800px" />
  <div class="image-caption">Muestro la ventana de trabajo con repositorios</div>
</div>
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-30.png" alt="Pido clonar un repositorio" width="300px" />
  <div class="image-caption">Pido clonar un repositorio</div>
</div>
- Pongo la URL de mi repositorio y dejo el resto de opciones sin cambiar.
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-01.png" alt="Pego la URL del repositorio" width="600px" />
  <div class="image-caption">Pego la URL del repositorio</div>
</div>
- Introduzco la contraseña que use al crear mis claves pública/privada SSH.
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-02.png" alt="Contraseña que usé al crear mis ficheros de clave publica/privada" width="600px" />
  <div class="image-caption">Contraseña que usé al crear mis ficheros de clave publica/privada</div>
</div>
- Este paso es opcional, decide qué hacer en tu caso
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-03.png" alt="Opcional, crear una clave maestra" width="600px" />
  <div class="image-caption">Opcional, crear una clave maestra</div>
</div>
- No cambio nada, me interesa descargar la rama principal (`main`)
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-04.png" alt="Pulso en Next" width="600px" />
  <div class="image-caption">Pulso en Next</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-05.png" alt="Compruebo el carpeta donde va a ser clonado y pulso en Finish" width="600px" />
  <div class="image-caption">Compruebo el carpeta donde va a ser clonado y pulso en Finish</div>
</div>
- Ya tenemos nuestro proyecto, repositorio git, activo en el IDE de Eclipse.
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-06.png" alt="A partir de ahora ya podemos trabajar en este proyecto compartido" width="600px" />
  <div class="image-caption">A partir de ahora ya podemos trabajar en este proyecto compartido</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-24.jpeg" alt="Abro un repositorio ya existente" width="800px" />
  <div class="image-caption">Abro un repositorio ya existente</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-07.png" alt="Crear nuevo proyecto" width="600px" />
  <div class="image-caption">Crear nuevo proyecto</div>
</div>
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-08.png" alt="Asigno el nombre QuiDomi." width="600px" />
  <div class="image-caption">Asigno el nombre QuiDomi.</div>
</div>
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-09.png" alt="Asigno el nombre quiDomi (empieza en minúsculas) en el module-info" width="600px" />
  <div class="image-caption">Asigno el nombre quiDomi (empieza en minúsculas) en el module-info</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-10.png" alt="Creo un Package y una Clase" width="600px" />
  <div class="image-caption">Creo un Package y una Clase</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-12.png" alt="Selecciono Team > Share Project" width="600px" />
  <div class="image-caption">Selecciono Team > Share Project</div>
</div>
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-13.png" alt="Selecciono el Repositorio Git" width="600px" />
  <div class="image-caption">Selecciono el Repositorio Git</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-14.png" alt="El Proyecto se vincula al Respositorio Git" width="600px" />
  <div class="image-caption">El Proyecto se vincula al Respositorio Git</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-15.png" alt="Modificación y compiación de prueba" width="600px" />
  <div class="image-caption">Modificación y compiación de prueba</div>
</div>

Decido iniciar el proceso de commit (mediante la opción `Team > Commit`)

<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-16.png" alt="Team > Commit (inicia el proceso)" width="350px" />
  <div class="image-caption">Team > Commit (inicia el proceso)</div>
</div>

Reviso los "Unstaged Changes". Es decir, qué ficheros todavía **no están en el area de intercambio (staging area)**.

<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-17.png" alt="Compruebo todos los Unstaged Changes" width="600px" />
  <div class="image-caption">Compruebo todos los Unstaged Changes</div>
</div>

Solicito que se muevan esos ficheros a la **Staging area**

<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-18.png" alt="Stage de las modificaciones" width="600px" />
  <div class="image-caption">Stage de las modificaciones</div>
</div>
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-19.png" alt="Stage de las modificaciones" width="600px" />
  <div class="image-caption">Stage de las modificaciones</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-20.png" alt="Modifico el mensaje de commit y hago un `commit & push`" width="600px" />
  <div class="image-caption">Modifico el mensaje de commit y hago un `commit & push`</div>
</div>
<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-21.png" alt="Valido el mensaje de confirmación" width="600px" />
  <div class="image-caption">Valido el mensaje de confirmación</div>
</div>

Compruebo en mi servidor `gitea` que se han recibido los cambios.

<div class="image-box">
  <img src="/img/posts/2022-10-27-quidomi-23.png" alt="Los cambios se han recibido en el servidor gitea" width="600px" />
  <div class="image-caption">Los cambios se han recibido en el servidor gitea</div>
</div>
...
| Os dejo aquí una pequeña chuleta sobre la *nomenclatura git*. Recuerda que tengo por aquí un par de apuntes más sobre [GIT en detalle]({{< relref "2021-04-17-git-en-detalle.md" >}}) y la [Chuleta sobre GIT]({{< relref "2021-10-10-git-cheatsheet.md" >}}). |
