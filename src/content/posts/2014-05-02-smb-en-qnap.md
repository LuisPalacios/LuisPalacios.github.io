...
<img src="/img/posts/logo-qnap.jpg" alt="logo qnap" width="150px" style="float:left; padding-right:25px"  />

**¿Qué es "SMB", "CIFS", "Samba" y los líos de las versiones?** SMB (Server Message Block) es un protocolo de red de nivel de aplicación que permite la compartición de archivos, impresoras y otros recursos entre dispositivos de una red. Originalmente desarrollado por IBM en la década de 1980, fue posteriormente adoptado y ampliamente mejorado por Microsoft, convirtiéndose en la base de la compartición de archivos en redes Windows.

El protocolo SMB ha evolucionado a través de múltiples versiones a lo largo de los años. SMB1 (también conocido como SMBv1 o NetBIOS) fue la implementación inicial, pero tenía limitaciones de seguridad y rendimiento. Microsoft introdujo mejoras significativas con SMB2 en Windows Vista y Windows Server 2008, y posteriormente SMB3 con Windows 8 y Windows Server 2012, cada versión agregando mejor rendimiento, seguridad mejorada y nuevas funcionalidades como cifrado de datos y compresión.
...
CIFS (Common Internet File System) es un "Dialecto" de SMB. Un dialecto es un conjunto de "mensajes" que definen una versión particular del protocolo SMB. Microsoft implementa SMB en sus equipo y añadió múltiples mejoras en su dialecto CIFS. Aunque técnicamente CIFS y SMB son diferentes, en la práctica los términos se utilizan indistintamente, ya que CIFS se basa en SMB y comparte la mayoría de sus características.

<div class="image-box">
  <img src="/img/posts/2014-05-02-smb-en-qnap-01.jpg" alt="Samba y QNAP Juntos" width="400px" />
  <div class="image-caption">Samba y QNAP Juntos</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2014-05-02-smb-en-qnap-03.png" alt="SMB Avanzado" width="600px" />
  <div class="image-caption">SMB Avanzado</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2014-05-02-smb-en-qnap-02.png" alt="Proyecto 'sanato' en GitHub" width="600px" />
  <div class="image-caption">Proyecto 'sanato' en GitHub</div>
</div>
