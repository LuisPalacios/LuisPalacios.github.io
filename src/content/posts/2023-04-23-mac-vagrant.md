...
<img src="/img/posts/logo-mac-vagrant.svg" alt="logo vagrant kvm" width="150px" height="150px" style="float:left; padding-right:25px"  />
...
<div class="image-box">
  <img src="/img/posts/2023-04-23-mac-vagrant-01.jpeg" alt="VirtualBox queda instalado en mi Mac" width="400px" />
  <div class="image-caption">VirtualBox queda instalado en mi Mac</div>
</div>

Hace tiempo escribí un apunte sobre cómo trabajar con Vagrant en Linux usando otro virtualizador: [Vagrant con Libvirt KVM]({{< relref "2021-05-15-vagrant-kvm.md" >}}).

> He visto que VirtualBox tiene una versión que corre de forma nativa sobre ARM y funciona correctamente, pero todavía no he conseguido que Vagrant levante una VM Linux ARM nativa o una VM Windows ARM nativa.

A modo de curiosidad, parece que `Parallels Desktop` permite instalar Windows 11 sobre ARM descargando la imagen desde los servidores de MS. Se puede activar con cualquier licencia válida de W7/8/10/11, dado que las licencias no tienen dependencia de la arquitectura. Así que en teoría se puede comprar W11 sobre ARM y hacerlo funcionar en un Parallels Desktop sobre M1/M2.

<br/>

### Vagrant

Recomiendo instalar Vagrant usando `Homebrew`. Si tienes un Mac lee el apunte [MAC para desarrollo]({{< relref "2023-04-15-mac-desarrollo.md" >}}) donde describo cómo instalar Homebrew y un montón de herramientas muy últiles para poder desarrollar en un Mac.
...
<div class="image-box">
  <img src="/img/posts/2023-04-23-mac-vagrant-02.jpeg" alt="VirtualBox queda instalado en mi Mac" width="600px" />
  <div class="image-caption">VirtualBox queda instalado en mi Mac</div>
</div>
...
En este repositorio en GitHub tienes un [maquina virtual para desarrollo de software preparada con Vagrant](https://github.com/LuisPalacios/devbox). Se trata de un repositorio con todo lo necesario para crear una máquina virtual orientada al Desarrollo de Software con Python y JupyterLabs. Podrás utilizar esta VM para conectar con servicios adicionales de Bases de Datos, cuadernos Jupyter de ejercicios. Tienes toda la información en el README del repositorio.
