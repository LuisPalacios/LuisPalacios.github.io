...
<img src="/img/posts/logo-zsh.svg" alt="logo user" width="150px" height="150px" style="float:left; padding-right:25px"  />
...
- **[~/.oh-my-posh.yaml](https://raw.githubusercontent.com/LuisPalacios/zsh-zshrc/main/.oh-my-posh.yaml)**: Tema para Oh My Posh, descrito más adelante.
...
La shell que viene por defecto en Ubuntu para WSL2 es *bash* pero la puedes cambiar exactamente igual que como lo haces en Linux y tambien te puedes instalar “tmux”, hablo sobre ello en este artículo sobre [Windows para desarrollo]({{< relref "2024-08-25-win-desarrollo.md#wsl-2---cambio-a-zsh" >}}).
...
- En linux (incluido WSL2), los temas quedan instalados en `$HOME/.cache/oh-my-posh/themes`, aunque yo uso mi tema modificado  **[~/.oh-my-posh.yaml](https://raw.githubusercontent.com/LuisPalacios/zsh-zshrc/main/.oh-my-posh.yaml)** que copio directamente a mi `$HOME`. Un ejemplo de instalación en `~/bin`.
...
Aqui tenemos dos sitios donde merece la pena instalarse:

- [Windows Powershell](https://ohmyposh.dev/docs/installation/windows) - Hice la instalación vía `winget`, para powershell con Windows Terminal: `winget install JanDeDobbeleer.OhMyPosh -s winget`
- [Windows WSL2](https://ohmyposh.dev/docs/installation/linux) - Instalación vía curl: `curl -s https://ohmyposh.dev/install.sh | bash -s -- -d ~/bin`

- Temas: quedan instalados en
  - `$HOME/.cache/oh-my-posh/themes` (en linux)
  - `POSH_THEMES_PATH=C:\Users\<user>\AppData\Local\Programs\oh-my-posh\themes\` (en windows)

Yo tengo aquí mi tema: **[~/.oh-my-posh.yaml](https://raw.githubusercontent.com/LuisPalacios/zsh-zshrc/main/.oh-my-posh.yaml)** que copio directamente a mi `$HOME`.

- Zsh - Nota para para WSL 2 (siguiente punto). En los unix uso **Oh My Posh junto con Zsh**, asi que recomiendo echarle un ojo a este [Repositorio en Gitub: Mis ficheros zsh](https://github.com/LuisPalacios/zsh-zshrc) y en concreto a mi fichero [.zshrc](https://raw.githubusercontent.com/LuisPalacios/zsh-zshrc/main/.zshrc).
