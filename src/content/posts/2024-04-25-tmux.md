...
<img src="/img/posts/logo-tmux.svg" alt="logo user" width="150px" height="150px" style="float:left; padding-right:25px"  />
...
Dejo aquí enlaces a mis ficheros de configuración. Te recomiendo que eches un ojo a mi apunte ["¡Adiós Bash, hola Zsh!"]({{< relref "2024-04-23-zsh.md" >}}).
