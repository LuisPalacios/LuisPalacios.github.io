...
<img src="/img/posts/logo-nodered.svg" alt="Logo nodered" width="150px" style="float:left; padding-right:25px"  />
...
Aquí voy a explicar el proceso de instalación, en una máquina virtual con Alpine y Docker por debajo. Si estás interesado, tengo otro apunte describiendo cómo lo [integro con mi *Home Assistant*]({{< relref "2022-10-02-nodered-hass.md" >}}).
...
<div class="image-box">
  <img src="/img/posts/2022-10-01-nodered-docker-01.jpg" alt="Arquitectura de la instalación" width="400px" />
  <div class="image-caption">Arquitectura de la instalación</div>
</div>
...
| IMPORTANTE: En este enlace tienes la [documentación para instalar Alpine + Docker]({{< relref "2022-03-20-alpine-docker.md" >}}). |
...
<div class="image-box">
  <img src="/img/posts/2022-10-01-nodered-docker-02.jpg" alt="Ejecución inicial" width="800px" />
  <div class="image-caption">Ejecución inicial</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2022-10-01-nodered-docker-04.png" alt="Ejecución inicial" width="250px" />
  <div class="image-caption">Ejecución inicial</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2022-10-01-nodered-docker-05.png" alt="imagen-1" width="600px" />
  <img src="/img/posts/2022-10-01-nodered-docker-06.png" alt="imagen-2" width="600px" />
  <div class="image-caption">Busco homeassistant y snmp para instalar integraciones</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2022-10-01-nodered-docker-07.png" alt="Actualización disponible para Home Assistant" width="600px" />
  <div class="image-caption">Actualización disponible para Home Assistant</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2022-10-01-nodered-docker-03.png" alt="Comprobar la versión" width="250px" />
  <div class="image-caption">Comprobar la versión</div>
</div>
