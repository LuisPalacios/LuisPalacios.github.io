...
<img src="/img/posts/logo-kodi-0.svg" alt="logo Kodi" width="150px" height="150px" style="float:left; padding-right:25px"  />
...
<div class="image-box">
  <img src="/img/posts/2015-01-26-media-center-casero-01.png" alt="mediacenter" width="600px" />
  <div class="image-caption">mediacenter</div>
</div>
...
La Raspberry Pi 2 Model B v1.1 (versión 2) soporta videos con los mismos bitrates dado que la tarjeta LAN es la misma que en la versión anterior (~40Mbps). Si quieres más información te recomiendo que pases al apunte, ([Media Center Pi+KODI/XBMC]({{< relref "2015-01-31-media-center.md" >}})), donde entro en detalle con ejemplos de uso.
