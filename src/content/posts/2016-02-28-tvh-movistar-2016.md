...
También tienes otra versión de un año antes ([versión del 2015]({{< relref "2015-01-31-tvh-movistar-2015.md" >}})) pero como habían cambiado algunas cosas las he documentado. Recuerda que uso un [router Linux]({{< relref "2014-10-05-router-linux.md" >}}) y *Kodi en Raspberry Pi* en vez del Router + Deco de Movistar.
