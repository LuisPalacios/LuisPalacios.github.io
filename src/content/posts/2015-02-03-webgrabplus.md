...
<img src="/img/posts/logo-tvhWebGrab+.svg" alt="logo WebGrab+" width="150px" height="150px" style="float:left; padding-right:25px"  />
...
Este apunte está relacionado con este sobre [Tvheadend y Movistar TV (2016)]({{< relref "2016-02-28-tvh-movistar-2016.md" >}}). Aquí describo como configurar WebGrab para bajarme el EPG desde otras fuentes. El programa WebGrab+Plus genera un fichero guide.xml en formato XMLTV que hay que pasarle a TVHeadEnd y que este a su vez actualiza a los XBMC (en Raspberri Pi en mi caso).

<div class="image-box">
  <img src="/img/posts/2015-02-03-webgrabplus-01.png" alt="Entorno con WebGrab+Plus" width="600px" />
  <div class="image-caption">Entorno con WebGrab+Plus</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2015-02-03-webgrabplus-02.png" alt="Configuración del grabber" width="600px" />
  <div class="image-caption">Configuración del grabber</div>
</div>
