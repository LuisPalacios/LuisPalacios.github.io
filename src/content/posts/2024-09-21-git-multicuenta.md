...
<img src="/img/posts/logo-git-multi.svg" alt="Logo GIT multicuenta" width="150px" style="float:left; padding-right:25px"  />
...
<div class="image-box">
  <img src="/img/posts/2024-09-21-git-multicuenta-01.png" alt="Credenciales bajo demanda" width="650px" />
  <div class="image-caption">Credenciales bajo demanda</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2024-09-21-git-multicuenta-02.png" alt="Credenciales en los almacenes seguros" width="400px" />
  <div class="image-caption">Credenciales en los almacenes seguros</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2024-09-21-git-multicuenta-03.jpg" alt="App Seahorse para acceder al GNOME Keyring" width="800px" />
  <div class="image-caption">App Seahorse para acceder al GNOME Keyring</div>
</div>
...
He hecho un programa que funciona en MacOS, Linux y Windows (WSL2) para simplificar la configuración de tus cuentas y repositorios. Te permite guardar en un único fichero JSON toda la configuración. El programa te puede guiar para crearlo y existe dos versiones, una para el CLI y otra GUI.

Échale un ojo: [gitbox](https://github.com/LuisPalacios/gitbox)
