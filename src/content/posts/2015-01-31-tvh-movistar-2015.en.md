---
title: "Tvheadend and TV (2015)"
date: "2015-01-31"
categories: ["tv"]
tags: ["linux","nuc"]
draft: false
cover:
  image: "/img/posts/logo-tvh2015.svg"
  hidden: true
---

<img src="/img/posts/logo-tvh2015.svg" alt="logo Tvheadend" width="150px" height="150px" style="float:left; padding-right:25px"  />

I published this post on Wordpress in January 2015 so, although outdated, you have a reference on how to install Tvheadend with XBMC/KODI as a client to watch Movistar TV channels.
...
- Tvheadend installation can be done directly from source or using, on Gentoo, the corresponding package:
...
- If in the future you want to update, simply run the following:

```shell
lunatv ~ # emerge -DuvNp system world
```

- File: `/etc/systemd/system/tvheadend.service`
...
- Finally, the configuration file. El parámetro más importante es el directorio al que apunta `TVHEADEND_CONFIG`. Ese directorio es en el que debes trabajar cuando quieras cambiar la configuración de tvheadend.
...
- These are the commands needed to enable, start and stop the service
...
- In each of the clients `XBMC` se añade el Add-On `Tvheadend HTSP Client` y se configura para acceder por `HTSP` al servidor donde se ejecuta el daemon de Tvheadend, por donde recibirá “lista” de canales, cómo llegar hasta ellos y más adelante el `EPG`.

<div class="image-box">
  <img src="/img/posts/2015-01-31-tvh-movistar-2015-03.png" alt="Instalación del cliente PVR de XBMC" width="600px" />
  <div class="image-caption">Instalación del cliente PVR de XBMC</div>
</div>

<div class="image-box">
  <img src="/img/posts/2015-01-31-tvh-movistar-2015-04.png" alt="Cliente PVR de XBMC" width="600px" />
  <div class="image-caption">Cliente PVR de XBMC</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2015-01-31-tvh-movistar-2015-06.png" alt="tvheadlist" width="600px" />
  <div class="image-caption">tvheadlist</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2015-01-31-tvh-movistar-2015-05.png" alt="tvheadendchannels" width="600px" />
  <div class="image-caption">tvheadendchannels</div>
</div>

| Important: I have created a Docker container para ejecutar Tvheadend, ya está 100% operativo, take a look, here are the projects where you have everything you need: |
...
#### Download and activate the EPG

El siguiente paso es ejecutar el programa (sin argumentos) para descargar el EPG. **Note:** en el fichero de configuración indicamos el nombre del fichero de salida y al llamarlo sin argumentos por defecto se dedica a bajarse el EPG. La primera vez lo ejecuto manualmente para verificar su funcionamiento e ir viendo el Log en paralelo.
...
<div class="image-box">
  <img src="/img/posts/2015-01-31-tvh-movistar-2015-02.png" alt="Fichero movistartv-guia.xml" width="700px" />
  <div class="image-caption">Fichero movistartv-guia.xml</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2015-01-31-tvh-movistar-2015-07.png" alt="xmltv-sock" width="600px" />
  <div class="image-caption">xmltv-sock</div>
</div>
...
<div class="image-box">
  <img src="/img/posts/2015-01-31-tvh-movistar-2015-01.png" alt="Electronic Program Guide de Movistar" width="600px" />
  <div class="image-caption">Electronic Program Guide de Movistar</div>
</div>
