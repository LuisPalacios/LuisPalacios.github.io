...
<img src="/img/posts/logo-jekyll.svg" alt="Logo Jekyll" width="150px" height="150px" style="float:left; padding-right:25px"  />
...
Seguro que conoces GitHub, una plataforma de colaboración y compartición de código (mediante el sistema de control de versiones `git`). Por cierto, más info [en mi apunte]({{< relref "2021-04-17-git-en-detalle.md" >}}) sobre GIT.
...
<div class="image-box">
  <img src="/img/posts/2021-04-19-nuevo-blog-01.jpg" alt="Arquitectura GitHub Pages" width="730px" />
  <div class="image-caption">Arquitectura GitHub Pages</div>
</div>
...
No es necesario instalar Python para lo que estamos discutiendo aquí, pero es un buen momento para hacerlo si lo vas a necesitar en el futuro. Aquí tienes un [apunte sobre Python en MacOS]({{< relref "2021-04-30-python-jupyter.md" >}})
