...
<img src="/img/posts/logo-docker-a.svg" alt="Logo docker" width="150px" style="float:left; padding-right:25px"  />
...
Necesitaba montar microservicios encima de Docker (hacía tiempo que no ([jugaba con Docker]({{< relref "2014-11-01-inicio-docker.md" >}})) dudé entre añadir Docker a mi servidor donde tengo KVM, dedicar un PC antiguo a Docker o pensar en algo más creativo...
...
- Networking: [Open vSwtich]({{< relref "2022-02-20-openvswitch.md" >}})
...
- Creo un puerto `estático` en mi switch virtual (más info aquí: [Open vSwitch y KVM]({{< relref "2022-02-20-openvswitch.md" >}})).
...
<div class="image-box">
  <img src="/img/posts/2022-03-20-alpine-docker-01.png" alt="Creo VM desde virt-manager" width="450px" />
...
- Creo `authorized_keys` ([apunte sobre SSH en linux]({{< relref "2009-02-01-ssh.md" >}}))
