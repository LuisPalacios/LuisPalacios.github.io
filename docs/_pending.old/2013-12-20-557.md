...
date: "2013-12-20"
categories: gentoo macos virtualizacion
tags: fusion linux virtualizacion vmware
...
![fusiongentoo-1_3_o](/assets/img/original/fusiongentoo-1_3_o.jpg){: width="730px" padding:10px } **Preparo discos, stage3 y portage ** Una vez que has hecho boot y tienes acceso a la red...
...
Nota: ![Aquí tienes un ejemplo](/assets/img/original/?p=581) de cómo hacer una configuración de dirección IP fija (manual){: width="730px" padding:10px }. **SSHD**
