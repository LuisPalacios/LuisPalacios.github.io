...
{% include showImagen.html
    src="/assets/img/original/?p=266)". Aquí me ocupo en detalle de la configuración de los "Videos bajo demanda". Desde el Decodificador es posible seleccionar y ver videos bajo demanda en dos situaciones: 1) reproducir una grabación o 2"
...
{% include showImagen.html
    src="/assets/img/original/) desarrollado para resolver precisamente este problema, identifica las peticiones de video bajo demanda (flujos RTSP"
    caption="pequeño pero potente paquete de software libre"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/4QZ2r7eV"
    caption="**pequeño parche**"
    width="600px"
    %}
