...
Una hora más tarde, sentado frente al cliente, hablando sobre nuestra propuesta de valor y discutiendo sobre qué tipo de aplicaciones o cargas podría mover a HyperFlex volvimos al punto de partida, al principio le enseñe [este video “todo empieza por decidir en qué lado quieres estar”](https://www.youtube.com/watch?v=gd2KHjZs_2g&list=PLmPWlwoQjRFWe4sCAi26cW_dId73Ory9Y), muy recomendado por cierto.

[![](https://www.luispa.com/wp-content/uploads/2017/01/cco-hyperflex0-300x166.png)](https://www.youtube.com/watch?v=gd2KHjZs_2g&list=PLmPWlwoQjRFWe4sCAi26cW_dId73Ory9Y)
...
[![](https://www.luispa.com/wp-content/uploads/2017/01/cco-hyperflex1.png)](https://www.luispa.com/wp-content/uploads/2017/01/cco-hyperflex1.png)

Ese es exactamente el enfoque que le hemos dado a la [plataforma Cisco HyperFlex](http://www-author.cisco.com/c/es_es/products/hyperconverged-infrastructure/index.html?wcmmode=disabled), además de lo que se le supone a un equipo Híper-Convergente también incluye un Nerworking Fabric integrado, una optimización de datos robusta y la gestión unificada, de fábrica. Aportan todo lo necesario para entregar inmediatamente valor y potencia, para poder echar a funcionar inmediatamente en múltiples casos de uso y tipos de cargas.

El enfoque es sencillo: crear un (pool) conjunto uniforme de recursos que admite aplicaciones a lo largo de todo clúster. Cuando se necesita provisionar cómputo o almacenamiento, pues se saca del pool. Se entregan las necesidades de almacenamiento de las VM’s desde el pool de recursos. Además, las ya “legendarias” capacidades de red de Cisco de sus [Fabric Interconnects](http://www.cisco.com/c/en/us/products/servers-unified-computing/ucs-6200-series-fabric-interconnects/index.html) (innovación que se introdujo en el mercado hace ya más de 7 años) proporcionan conectividad de baja latencia y ancho de banda de 10 Gbps para todos los componentes del sistema. Traducido, pues que en un solo conjunto de cables tenemos funcionalidad, simplificación, seguridad y aislamiento.
...
- El [blog de Hyperflex](http://blogs.cisco.com/datacenter/why-cisco-customers-love-extending-ucs-deployments-with-hyperflex?_ga=1.38246822.429478222.1479822338)
- El “[White Paper](http://www.cisco.com/c/dam/en/us/products/collateral/hyperconverged-infrastructure/hyperflex-hx-series/white-paper-c11-736814.pdf)” de la Plataforma
- La [Web oficial Cisco HyperFlex](http://www-author.cisco.com/c/es_es/products/hyperconverged-infrastructure/index.html?wcmmode=disabled)
