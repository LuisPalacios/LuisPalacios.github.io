...
{% include showImagen.html
    src="/assets/img/original/1284) por cable Ethernet"
    caption="raspberry con Kodi"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/Transcoding-300x235.jpg"
    caption="Transcoding"
    width="600px"
    %}
...
- **Soporte nativo en el Kernel, Sistema Operativo, FFMPEG accediendo a QSV vía VAAPI**
    - Ventaja: Funciona.
{% include showImagen.html
    src="/assets/img/original/4876#linuxnativo"
    caption="Soporte nativo de Intel QSV+VAAPI en Linux"
    width="600px"
    %}
{% include showImagen.html
    src="/assets/img/original/VA_API "VA API"), tanto para encoding como decoding, así ques VAAPI es el método preferido para poder "consumir" dicho Hardware (QSV"
    caption="VA API"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/4443"
    caption="issue 4443 es más moderno"
    width="600px"
    %}
{% include showImagen.html
    src="/assets/img/original/4876#tvhnativo"
    caption="Lo iré documentando en la sección "](https://tvheadend.org/issues/4443)[Tvheadend con soporte nativo VAAPI"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/4876#tvhsdk"
    caption="Tvheadend con SDK Quick Sync"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/VAAPI"
    caption="https://wiki.gentoo.org/wiki/VAAPI"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/ffmpegGPUuse-1024x492.png"
    caption="ffmpegGPUuse"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/intel_gpu_tool-1024x534.png"
    caption="intel_gpu_tool"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/Video_Acceleration_API) directo (**V**ideo **A**cceleration **API**"
    caption="VA API"
    width="600px"
    %}

{% include showImagen.html
    src="/assets/img/original/3831), como todo, cuantos más lo pidan mejor :-"
    caption="te invito a registrarte en Tvheadend y pidas en este hilo #3831 que lo implementen"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/mfx_dispatch.git"
    caption="https://github.com/lu-zero/mfx_dispatch.git"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/tvheadend), en vez de usar `emerge` porque me permite ir haciendo pruebas con las distintas liberías (elegir usar las del sistema o las de SDK"
    caption="Tvheadend **"a pelo"** desde GitHub"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/TransOptions-300x185.png"
    caption="TransOptions"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/TransVAAPI-1024x694.png"
    caption="TransVAAPI"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/TransSW-300x283.png"
    caption="TransSW"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/transSW-1024x576.jpg"
    caption="transSW"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/transbw.png"
    caption="transbw"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/3831#change-19620)" tiene una branch (**codecs**"
    caption="**lekma**](https://github.com/lekma/tvheadend) que según el hilo "[Feature #3831: VAAPI Encoding via FFmpeg"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/nuc-d54250wyk-mss.jpg"
    caption="nuc-d54250wyk-mss"
    width="600px"
    %}
...
{% include showImagen.html
    ...
    caption="Intel® Media Server Studio – Community Edition"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/centosqsv-1024x563.jpg"
    caption="centosqsv"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/HWAccelIntro"
    caption="Subsistema de aceleración HW de FFMPEG"
    width="600px"
    %}
{% include showImagen.html
    src="/assets/img/original/VA_API) ofrece acceso al hardware gráfico (GPU"
    caption="VA API (Video Acceleration API)"
    width="600px"
    %}
{% include showImagen.html
    src="/assets/img/original/download.aspx?productid=2813&pass=yes"
    caption="INTEL: Página de descarga del "Intel® Media Server Studio – Community Edition""
    width="600px"
    %}
    - Es necesario que estes registrado, podrása bajarte el Intel® Media Server Studio for Linux,
{% include showImagen.html
    src="/assets/img/original/mfx_dispatch"
    caption="INTEL: Open Source - Intel Media SDK Dispatcher (lu-zero/mfx_dispatch)"
    width="600px"
    %}
{% include showImagen.html
    src="/assets/img/original/linuxgraphics"
    caption="INTEL: Información - Intel Graphic Stack para diferentes plataformas"
    width="600px"
    %}
{% include showImagen.html
    src="/assets/img/original/"
    caption="INTEL: Driver Intel para VAAPI"
    width="600px"
    %}
{% include showImagen.html
    src="/assets/img/original/Intel"
    caption="Gentoo: Driver "**Intel**" open source para tener acceso a la tarjeta gráfica de los NUC"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/VAAPI"
    caption="Gentoo: VAAPI"
    width="600px"
    %}
    - Describe cómo activar VAAPI (Video Acceleration API) en un equipo con Gentoo.
{% include showImagen.html
    src="/assets/img/original/GM45"
    caption="Gentoo: Enable hardware H264 decoding on Intel G/GM45"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/3080"
    caption="Primera (aunque algo desactualizada) https://tvheadend.org/issues/3080"
    width="600px"
    %}
{% include showImagen.html
    src="/assets/img/original/tvh_qsv"
    caption="parches para Kernel 4.6 (ojo todavía no me funcionan)"
    width="600px"
    %}
{% include showImagen.html
    src="/assets/img/original/3831"
    caption="Segunda (más interesante y actualizada) https://tvheadend.org/issues/3831"
    width="600px"
    %}
...
{% include showImagen.html
    src="/assets/img/original/mpv"
    caption="mpv, un media player ligero basado en MPlayer"
    width="600px"
    %}
