...
Aprovechando el contrato que tengo con Movistar voy a configurar mi asterix para que pueda usar mi teléfono de casa (en mi caso del tipo `911234567`). Puedes consultar mi [sip.conf](https://gist.github.com/LuisPalacios/985adb8affd58e679c103b7ecf512de6).
