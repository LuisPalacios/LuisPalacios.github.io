...
En mi caso estoy utilizando el Servidor XQuartz en mi MacOS. XQuartz es un projecto de código abierto que desarrolla una versión del "X.Org X Window System" que funciona en MacOS. 

El proceso de instalación es muy sencillo, descar el DMG que encontrarás en https://www.xquartz.org e instálalo en tu Mac. 
