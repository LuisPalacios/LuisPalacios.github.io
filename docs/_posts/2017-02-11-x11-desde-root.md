...
![logo ssh xorg](/assets/img/posts/logo-ssh-xorg.svg){: width="150px" height="150px" style="float:left; padding-right:25px" } 
...
Nota: En mi caso estoy utilizando el Servidor XQuartz en mi MacOS. XQuartz es un projecto de código abierto que desarrolla una versión del "X.Org X Window System" que funciona en MacOS. El proceso de instalación es muy sencillo, descar el DMG que encontrarás en [XQuartz.com](https://www.xquartz.org) e instálalo en tu Mac. 
