...
| Encontrarás un par de apuntes sobre GIT en mi blog, te recomiendo [GIT en detalle]({% post_url 2021-04-17-git-en-detalle %}) y la [Chuleta sobre GIT]({% post_url 2021-10-10-git-cheatsheet %}). Más adelante escribí un apunte sobre como [instalar Gitea y Traefik en Docker]({% post_url 2022-03-27-gitea-docker %}). |
