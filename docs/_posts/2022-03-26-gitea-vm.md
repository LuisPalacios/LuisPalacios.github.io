...
| Encontrarás un par de apuntes sobre GIT en mi blog, te recomiendo el que hice sobre [GIT en detalle]({% post_url 2021-04-17-git-en-detalle %}) y este [Chuleta sobre GIT]({% post_url 2021-10-10-git-cheatsheet %})|
