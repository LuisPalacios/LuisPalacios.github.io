...
| Encontrarás un par de apuntes sobre GIT en mi blog, te recomiendo [GIT en detalle]({% post_url 2021-04-17-git-en-detalle %}) y la [Chuleta sobre GIT]({% post_url 2021-10-10-git-cheatsheet %}). Más adelante escribí un apunte sobre como [instalar Gitea y Traefik en Docker]({% post_url 2022-04-03-gitea-docker %}). |
...
Desde mi servidor con QEMU/KVM lanzo `virt-manager` → Nueva máquina virtual, uso el ISO anterior y llamo al servidor `git.tudominio.com` (el dominio es privado, servido por mi [propio DNS Server]({% post_url 2021-06-20-pihole-casero %})).
...
{% include showImagen.html 
      ...
      caption="Conecto con la instalación de Gitea en http://git.tudominio.com:3000" 
      width="800px"
      %}
...
{% include showImagen.html 
      ...
      caption="Conecto con la página principal de nuevo en http://git.tudominio.com:3000" 
      width="800px"
      %}
