...
- Para que funcione lo que explico, me apoyo en [Git y SSH multicuenta]({% post_url 2021-10-09-ssh-git-dual %})
...
6. Por último quiero que cada Repositorio pueda estar configurado con el usuario/mail/clave-ssh para GitHub adecuando y que VSCode no se lie. Llego al **Paso 5: configuro correctamente la forma de trabajar en modo [Git y SSH multicuenta]({% post_url 2021-10-09-ssh-git-dual %})**
...
- Lenguaje C++
  - [ms-vscode.cpptools]((mira [Modificar el PATH](#modificar-el-path)) - Añade soporte del lenguage C/C++ a Visual Studio Code, incluyendo edición (IntelliSense) y debugging.
  - `CMake` de twxs (twxs.cmake)
  - `CMake Tools` de Microsoft (ms-vscode.cmake-tools)
